...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="fw-semibold mb-0"><i class="bi bi-trophy me-2 text-success"></i><?= lang('Crm.new_opportunity') ?></h5>
    ...
    <div class="card-body">
        <form method="post" action="/opportunities/create" novalidate>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i><?= lang('Crm.create_opportunity') ?></button>
                <a href="/opportunities" class="btn btn-outline-secondary"><?= lang('Crm.cancel') ?></a>
            </div>
        </form>
    </div>
</div>
